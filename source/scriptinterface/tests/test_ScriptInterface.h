...
public:
	...
	void test_clone_basic()
	{
...

		{
			...
			JS::RootedValue obj2(rq2.cx, script2.CloneValueFromOtherCompartment(script1, obj1, JS::StructuredCloneScope::SameProcessSameThread));
	...
	void test_rooted_templates()
	{
		...
		ScriptInterface::FromJSVal(rq.cx, out, nbr);
	...
	void test_function_override()
	{
		...
		int outNbr = 0;
		ScriptInterface::FromJSVal(rq.cx, out, outNbr);
